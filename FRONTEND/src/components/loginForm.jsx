        ...
        <div style={styles.mainContent}>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.separator}>
              ...
              <span style={styles.separatorText}>Or continue with email</span>
            </div>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div style={styles.rememberRow}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  />
                  <label htmlFor="remember" style={{ fontSize: '0.875rem', color: '#4b5563' }}>
                    Remember me
                  </label>
                </div>
            ...
            <div style={styles.signupText}>
              ...
              <Link to="/register" style={styles.signupLink}>Sign up for free</Link>
            </div>
          </div>
